...
export class CommonSortPage extends Component{
    ...
    renderSelectedItemView = (item,index) => {
        const clearIcon = this.state.isEditState ? <Image style={styles.selected_item_icon} source={require('../data/img/clear.png')}/> : undefined
        return (
